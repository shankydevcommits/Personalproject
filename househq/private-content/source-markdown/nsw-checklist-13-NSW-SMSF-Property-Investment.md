...
### New South Wales state notes included. Core rules are federal — read this before you do anything else.
...
## Section 5 — New South Wales-Specific Considerations

- [ ] **Check NSW land tax settings for SMSF-held property.** NSW's general land tax threshold is **$1,075,000** for individuals — but SMSF property is typically held via a bare trust (for LRBAs) or the corporate trustee directly, and **trust land tax treatment can differ meaningfully** from individual ownership. Get this checked specifically for your fund's structure.
- [ ] **Check foreign purchaser surcharge exposure (5% land tax surcharge, 9% surcharge duty)** if any fund member could be considered a foreign person for these purposes — this needs specific advice given how SMSF ownership structures are assessed.
- [ ] **Standard NSW transfer duty applies to SMSF property purchases** — there's no concession available to a superannuation fund. See the separate Property Investment Purchase Checklist (NSW) in this series for the general investor stamp duty and land tax framework your SMSF purchase sits on top of.
- [ ] **Engage a NSW solicitor or conveyancer experienced specifically with SMSF/bare trust transactions** — correctly naming the trustee structure in the Contract of Sale is a common error point.
