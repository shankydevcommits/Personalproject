...
### Queensland state notes included. Core rules are federal — read this before you do anything else.
...
## Section 5 — Queensland-Specific Considerations

- [ ] **Check Queensland land tax settings for SMSF-held property.** Queensland's land tax threshold is **$600,000 for individuals** but only **$350,000 for companies and trusts** — and SMSF property is typically held via a bare trust (LRBA) or corporate trustee, so the *lower* trust/company threshold is likely to apply to your fund's holding, not the individual threshold. Get this checked specifically for your fund's structure.
- [ ] **Check the absentee owner surcharge (3%) and Additional Foreign Acquirer Duty (7%)** if any fund member could be considered a foreign or absentee entity for these purposes.
- [ ] **Since 1 August 2025, Queensland requires a Seller Disclosure Statement before you sign** — this applies to your SMSF's purchase exactly as it would to any other buyer; make sure your SMSF solicitor reviews it with the fund's compliance obligations in mind, not just standard buyer protections.
- [ ] **Standard Queensland transfer duty applies to SMSF property purchases** — there's no concession available to a superannuation fund. See the separate Property Investment Purchase Checklist (Queensland) in this series for the general investor stamp duty and land tax framework your SMSF purchase sits on top of.
- [ ] **Engage a Queensland solicitor experienced specifically with SMSF/bare trust transactions** — correctly naming the trustee structure in the contract is a common error point.
