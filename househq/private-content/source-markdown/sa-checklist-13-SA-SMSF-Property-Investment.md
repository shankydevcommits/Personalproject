...
### South Australia state notes included. Core rules are federal — read this before you do anything else.
...
## ⚠️ Read This First: The Rules Are Changing on 10 August 2026
...
## Section 5 — South Australia-Specific Considerations

- [ ] **Check SA land tax settings for SMSF-held property — this is the single biggest state-specific issue for SA SMSF investors.** SA's individual land tax threshold is around **$833,000**, but land held in a **trust** faces a threshold of just **$25,000**. Since SMSF property is typically held via a bare trust (LRBA) or corporate trustee, your fund's holding is very likely to be assessed against the much lower trust threshold — meaning land tax can apply from a far lower property value than an individual investor might expect. Get a specific written comparison from your accountant before proceeding.
- [ ] **Check the 7% foreign ownership surcharge** if any fund member could be considered a foreign person for these purposes.
- [ ] **Remember SA's cooling-off period is just 2 clear business days** — the shortest in the country. Ensure your SMSF's bare trust and finance arrangements (where still available) are genuinely ready before your trustee signs, since there's very little time to sort out problems afterward.
- [ ] **Standard SA stamp duty applies to SMSF property purchases** — there's no concession available to a superannuation fund. See the separate Property Investment Purchase Checklist (SA) in this series for the general investor stamp duty and land tax framework your SMSF purchase sits on top of.
- [ ] **Engage a SA conveyancer experienced specifically with SMSF/bare trust transactions** — correctly naming the trustee structure in the contract is a common error point.
...
*© HouseHQ. General information only, current as at the date shown — this is not financial, legal, tax or superannuation advice, and is not a recommendation regarding any specific financial product. SMSF property decisions are complex and high-consequence — always engage a licensed SMSF specialist adviser, SMSF auditor, and solicitor before proceeding. Confirm current LRBA and Division 296 settings directly with the ATO (ato.gov.au) given how recently these rules changed.*
